...
def fetch_bitcoin_history_from_coingecko():
    """
    Coleta dados horários do Bitcoin na janela "último ano"
    usando CoinGecko /coins/bitcoin/market_chart/range.
    """
    ctx = get_current_context()

    # Janela dos últimos 360 dias para montar uma série longa de dados de preços diários. 
    # Garante que o parâmetro "interval" automaticamente seja setado para "diário".
    ...
    # if_exists = replace; substitui a última janela de 360 dias
